...
plugins=(brew capistrano coffee colorize cp docker git git-flow-avh github lein node npm osx pip postgres rake ruby rvm tmux tmuxinator vi-mode vagrant vagrant-prompt)
